...
class ClientPrefs {
	...
	public static var mobileBinds:Map<String, Array<MobileInputID>> = [
		...
		'5k_note_2'		=> [NOTE_LEFT],
		'5k_note_3'		=> [NOTE_DOWN],
		'5k_note_4'		=> [NOTE_RIGHT],
		'5k_note_5'		=> [HITBOX_NOTE_5],
	
		'6k_note_1'		=> [NOTE_UP],
		'6k_note_2'		=> [NOTE_LEFT],
		'6k_note_3'		=> [NOTE_DOWN],
		'6k_note_4'		=> [NOTE_RIGHT],
		'6k_note_5'		=> [HITBOX_NOTE_5],
		'6k_note_6'		=> [HITBOX_NOTE_6],
	
		'7k_note_1'		=> [NOTE_UP],
		'7k_note_2'		=> [NOTE_LEFT],
		'7k_note_3'		=> [NOTE_DOWN],
		'7k_note_4'		=> [NOTE_RIGHT],
		'7k_note_5'		=> [HITBOX_NOTE_5],
		'7k_note_6'		=> [HITBOX_NOTE_6],
		'7k_note_7'		=> [HITBOX_NOTE_7],
	
		'8k_note_1'		=> [NOTE_UP],
		'8k_note_2'		=> [NOTE_LEFT],
		'8k_note_3'		=> [NOTE_DOWN],
		'8k_note_4'		=> [NOTE_RIGHT],
		'8k_note_5'		=> [HITBOX_NOTE_5],
		'8k_note_6'		=> [HITBOX_NOTE_6],
		'8k_note_7'		=> [HITBOX_NOTE_7],
		'8k_note_8'		=> [HITBOX_NOTE_8],

		'9k_note_1'		=> [NOTE_UP],
		'9k_note_2'		=> [NOTE_LEFT],
		'9k_note_3'		=> [NOTE_DOWN],
		'9k_note_4'		=> [NOTE_RIGHT],
		'9k_note_5'		=> [HITBOX_NOTE_5],
		'9k_note_6'		=> [HITBOX_NOTE_6],
		'9k_note_7'		=> [HITBOX_NOTE_7],
		'9k_note_8'		=> [HITBOX_NOTE_8],
		'9k_note_9'		=> [HITBOX_NOTE_9],
