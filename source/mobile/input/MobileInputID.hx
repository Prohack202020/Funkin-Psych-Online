 ...
 */
@:runtimeValue
@:build(mobile.macros.ButtonMacro.createExtraButtonIDs(10, 48))
enum abstract MobileInputID(Int) from Int to Int {
	...
	var HITBOX_RIGHT = 41;
	var TAUNT = 42;
	var HITBOX_NOTE_5 = 43;
	var HITBOX_NOTE_6 = 44;
	var HITBOX_NOTE_7 = 45;
	var HITBOX_NOTE_8 = 46;
	var HITBOX_NOTE_9 = 47;
